        ...
        <section className="bg-surface-container-low py-24 px-8 md:px-16 overflow-hidden mb-24">
          <div className="flex flex-col md:flex-row gap-16">
            <div className="md:w-1/3 md:sticky md:top-32 h-fit">
              ...
              <div className="group bg-primary text-on-primary rounded-sm shadow-xl hover:translate-y-[-4px] transition-transform overflow-hidden relative min-h-[300px]">
                <Image 
                ...
                <div className="absolute inset-0 p-8 flex flex-col justify-end">
                  <span className="material-symbols-outlined mb-4" style={{ fontVariationSettings: "'FILL' 1" }}>local_drink</span>
                  <h3 className="font-headline text-2xl mb-2 italic">Windmills Craftworks</h3>
                  <p className="text-sm opacity-90 leading-relaxed mb-6">Not just a brewery, but a sanctuary of jazz, rare books, and the finest Hefeweizen in India.</p>
                  <a 
                    href="https://maps.app.goo.gl/RCHGqaQGTBw2AvW96" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 text-[10px] uppercase tracking-[0.2em] font-label border border-on-primary/30 py-2 px-4 hover:bg-on-primary hover:text-primary transition-colors w-fit"
                  >
        ...
        <section className="py-24 px-8 md:px-16 mb-24">
          <div className="mb-12 flex justify-between items-end border-b border-outline-variant pb-8">
            <div>
              ...
              <h2 className="font-headline text-5xl text-primary">Shopping Anthology</h2>
            </div>
